...
import com.mvvm.quotes.databinding.FragmentFavoriteQuotesBinding
...
class Favorites : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_favorite_quotes, container, false)
        return binding.root
    }
